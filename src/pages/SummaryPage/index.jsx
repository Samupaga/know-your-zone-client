  ...
  return (
    <div className="page-wrapper">
      ...
      <div className="six-tile-wrapper">
        <BigNumberCard className={"pink six-tile"} value={1200} smallNumber={"pcm"} secondaryInfo={"Average Rent"} />
        <CardHIP
        ...
        />
        <BigNumberCard className={"pink six-tile"} value={87} smallNumber={"/1000"} secondaryInfo={"Average Crime Rate"} />
        <CardHPP className={"yellow six-tile"} heading={"Rent"} primaryInfo={"⬇️"} secondaryInfo={"Below London Average"} />
