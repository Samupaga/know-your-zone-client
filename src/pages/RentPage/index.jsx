...
export default function RentPage({ navSearchSearching, motto }) {
  ...
  if (isLoading === false) {
    return (
      <AnimatePresence>
        <motion.div initial={{ x: 300, opacity: 0 }} animate={{ x: 0, opacity: 1 }} exit={{ x: -300, opacity: 0 }} className="rent-tile-wrapper">
          <CardHIP
          ...
          />
          <CardHIP className={"right-column card blue rent-item-2"} chartType={"donut"} heading={"Split of some data"} />
          ...
          <div className="four-tile-wrapper right-column">
            <CardHP className={"card pink four-tile rent-item-4"} heading={`£${generalRent[2]["rent_median"]}`} secondaryInfo={"Single Room"} />
            <CardHP className={"card pink four-tile rent-item-5"} heading={`£${generalRent[1]["rent_median"]}`} secondaryInfo={"1 Bed"} />
            <CardHP className={"card pink four-tile rent-item-6"} heading={`£${generalRent[4]["rent_median"]}`} secondaryInfo={"3 Bed"} />
            <CardHP className={"card pink four-tile rent-item-7"} heading={`£${generalRent[0]["rent_median"]}`} secondaryInfo={"4+ Bed"} />
          </div>
        </motion.div>
      </AnimatePresence>
    );
